    ...
    <>
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: 7, flexWrap: "wrap", marginBottom: 16 }}>
            {project.tags.map((tag) => (
              <span key={tag} style={{
                ...
                background: "rgba(0,184,148,0.08)", padding: "3px 10px",
                borderRadius: 20, border: "1px solid rgba(0,184,148,0.15)",
              }}>
                {tag}
              </span>
            ))}
          ...
          {/* Title */}
          <h3 style={{
            fontFamily: "serif", fontSize: 24, color: "#e8e8e8",
          ...
          {/* Context */}
          <p style={{
            fontFamily: "sans-serif", fontSize: 14, lineHeight: 1.75,
          ...
          <div style={{ display: "flex", gap: 12, marginTop: "auto" }}>
            ...
            {project.demoUrl && (
              <button onClick={() => setShowDemo(true)} style={{
                ...
                padding: "7px 16px", background: "#00b894", borderRadius: 6,
        ...
        <div style={{
            ...
            <span style={{ fontFamily: "monospace", fontSize: 24, color: "#333" }}>📸</span>
            <span style={{ fontFamily: "monospace", fontSize: 10, color: "#444", letterSpacing: 1 }}>
                SCREENSHOTS
            </span>
            </div>
          ...
          >
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <span style={{ fontFamily: "monospace", fontSize: 12, color: "#888", marginLeft: 10 }}>
                  {project.title} — Live Demo
                </span>
              </div>
              <button onClick={() => setShowDemo(false)} style={{
                fontFamily: "monospace", fontSize: 18, color: "#666",
