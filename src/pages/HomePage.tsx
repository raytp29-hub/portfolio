  ...
  return (
    ...
    <div
      ...
      <section id="home" style={{
        ...
        <GaussianHero />
        <div style={{ position: "relative", zIndex: 1, padding: isMobile ? "0 20px" : "0 48px", maxWidth: 700 }}>
          ...
          <h1 style={{
            fontFamily: "serif", fontSize: "clamp(44px, 6vw, 74px)",
            color: "#f2f2f2", fontWeight: 400, lineHeight: 1.05, marginBottom: 24,
          }}>
            Biagio Spada
          </h1>
          <p style={{
            fontSize: 16, lineHeight: 1.85, color: "#888",
            maxWidth: 500, marginBottom: 40,
          }}>
            Operations professional with 7 years of experience building tools and optimizing processes. 
            Now applying that problem-solving mindset to data analysis — with Python, SQL, and interactive dashboards.
          </p>
        ...
        <div style={{
          ...
          background: "linear-gradient(transparent, #212121)", zIndex: 2,
        }} />
      </section>

      {/* Projects */}
      <section id="projects" style={{ padding: isMobile ? "60px 20px" : "100px 48px", maxWidth: 1080, margin: "0 auto" }}>
      ...
      {/* Skills */}
      <section id="skills" style={{ padding: isMobile ? "60px 20px" : "80px 48px", maxWidth: 1080, margin: "0 auto" }}>
        <SectionHeader label="Skills" title="Stack & Tools" />
      <div style={{
          display: "grid",
          gridTemplateColumns: isMobile ? "1fr" : "1.4fr",
          gap: 32,
          alignItems: "start",
        }}>
          {/* Left — skill bars */}
          ...
          {/* Right — themed window */}
            <div style={{ position: isMobile ? "relative" : "sticky", top: isMobile ? undefined : 100, }}>
              <div
                key={activeSkill}
                style={{
      ...
      {/* About */}
      <section id="about" style={{ padding: isMobile ? "60px 20px 100px" : "80px 48px 140px", maxWidth: 780, margin: "0 auto" }}>
