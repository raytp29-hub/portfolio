  ...
  return (
    <div style={{
      ...
      <section id="home" style={{
        ...
        <GaussianHero />
        <div style={{ position: "relative", zIndex: 1, padding: "0 48px", maxWidth: 700 }}>
          ...
          <p style={{
            ...
            Operations manager transitioning into data & tech.
            I build tools that turn data into decisions.
          </p>
      ...
      {/* Projects */}
      <section id="projects" style={{ padding: "100px 48px", maxWidth: 1080, margin: "0 auto" }}>
      ...
      {/* Skills */}
      <section id="skills" style={{ padding: "80px 48px", maxWidth: 1080, margin: "0 auto" }}>
            ...
            {SKILLS.map((skill, index) => (
              <SkillBar
                ...
                onSelect={() => {
                    ...
                    // Riprendi dopo 8 secondi di inattività
      ...
      {/* About */}
      <section id="about" style={{ padding: "80px 48px 140px", maxWidth: 780, margin: "0 auto" }}>
